...
<body>
	...
	<div id="main" style="padding-top: 30px">
		...
		$sql2 = "SELECT `temp`, `humid` FROM `ndda` WHERE 1";
                    ...
                    <div class="col-div-4">
                        <div class="box-4">
                            <div class="content-box">
                                <p>Độ ẩm</p>
                                <section class="row">
                                    <svg class="radial-progress" data-percentage="' . $humid . '" viewBox="0 0 80 80">
                    ...
                    <div class="col-div-4">
                        <div class="box-4">
                            <div class="content-box">
                                <p>Nhiệt độ</p>
                                <section class="row">
                                    <svg class="radial-progress2" data-percentage="' . $temp . '" viewBox="0 0 80 80">
					...
					$(window).scroll(function() {
						$('svg.radial-progress2').each(function(index, value) {
							...
							if (
								...
								strokeDashOffset = circumference - ((percent * circumference) / 100);
								// Transition progress for 1.25 seconds
								$(this).find($('circle.complete2')).animate({
									'stroke-dashoffset': strokeDashOffset
								}, 1250);
							}
						});
