...
const char* host = "192.168.1.105"; //host thi bo http
const char* servername = "http://192.168.1.105/ezroom_test/data.txt"; // cho them http
...
void loop() {
  ...
  if(led1 != oldled1 || led2 != oldled2 ||led3 != oldled3 ||led4 != oldled4){
    client.print(String("GET http://192.168.1.105/ezroom_test/connect.php?")
                    +("&led1=") + led1
                    +("&led2=") + led2
                    +("&led3=") + led3
                    +("&led4=") + led4
